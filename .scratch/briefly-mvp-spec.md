...
15. As the owner, I want to delete a Brief and later request a new generation, so that I can remove unwanted material without editing generated content in place.
...
- Verify owner-gated behavior end to end at the application boundary: unauthenticated users cannot create, retry, delete, or read personal Briefs; the owner can; and public readers can only see the seeded Demo Library.
